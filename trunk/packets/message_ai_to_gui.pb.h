...
class GUIRobot : public ::google::protobuf::Message {
 public:
  ...
  inline ::google::protobuf::int32 current_theta() const;
  inline void set_current_theta(::google::protobuf::int32 value);
  ...
  inline ::google::protobuf::int32 future_theta() const;
  inline void set_future_theta(::google::protobuf::int32 value);
 ...
 private:
  ...
  ::google::protobuf::int32 current_theta_;
  ::google::protobuf::int32 future_x_;
  ::google::protobuf::int32 future_y_;
  ::google::protobuf::int32 future_theta_;
...
inline ::google::protobuf::int32 GUIRobot::current_theta() const {
  return current_theta_;
}
inline void GUIRobot::set_current_theta(::google::protobuf::int32 value) {
  _set_bit(2);
...
inline ::google::protobuf::int32 GUIRobot::future_theta() const {
  return future_theta_;
}
inline void GUIRobot::set_future_theta(::google::protobuf::int32 value) {
  _set_bit(5);
  future_theta_ = value;
}
