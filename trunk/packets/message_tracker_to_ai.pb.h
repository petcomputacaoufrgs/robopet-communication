...
inline ::google::protobuf::int32 RobotTracker::x() const {
  return x_;
}
inline void RobotTracker::set_x(::google::protobuf::int32 value) {
  _set_bit(0);
  x_ = value;
}
...
inline ::google::protobuf::int32 RobotTracker::y() const {
  return y_;
}
inline void RobotTracker::set_y(::google::protobuf::int32 value) {
  _set_bit(1);
  y_ = value;
}
...
inline ::google::protobuf::int32 RobotTracker::theta() const {
  return theta_;
}
inline void RobotTracker::set_theta(::google::protobuf::int32 value) {
  _set_bit(2);
  theta_ = value;
}
