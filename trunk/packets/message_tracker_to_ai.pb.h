...
inline ::google::protobuf::uint32 RobotTracker::x() const {
  return x_;
}
inline void RobotTracker::set_x(::google::protobuf::uint32 value) {
  _set_bit(0);
  x_ = value;
}
...
inline ::google::protobuf::uint32 RobotTracker::y() const {
  return y_;
}
inline void RobotTracker::set_y(::google::protobuf::uint32 value) {
  _set_bit(1);
  y_ = value;
}
