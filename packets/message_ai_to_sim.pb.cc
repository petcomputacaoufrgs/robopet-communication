...
void protobuf_AddDesc_message_5fai_5fto_5fsim_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\007RobotAI\022\t\n\001r\030\003 \002(\005\022\r\n\005theta\030\004 \002(\005\022\r\n\005om"
    "ega\030\005 \002(\005\022\032\n\022movement_intensity\030\006 \002(\005\022\025\n"
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        ...
        if (input->ExpectTag(32)) goto parse_theta;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(40)) goto parse_omega;
        break;
      }
      ...
      case 5: {
        ...
        if (input->ExpectTag(48)) goto parse_movement_intensity;
        break;
      }
...
void RobotAI::SerializeWithCachedSizes(
  ...
  // required int32 theta = 4;
  if (_has_bit(1)) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(4, this->theta(), output);
  }
  
  // required int32 omega = 5;
  if (_has_bit(2)) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(5, this->omega(), output);
  }
  
  // required int32 movement_intensity = 6;
  if (_has_bit(3)) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(6, this->movement_intensity(), output);
  }
...
::google::protobuf::uint8* RobotAI::SerializeWithCachedSizesToArray(
  ...
  // required int32 theta = 4;
  if (_has_bit(1)) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(4, this->theta(), target);
  }
  
  // required int32 omega = 5;
  if (_has_bit(2)) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(5, this->omega(), target);
  }
  
  // required int32 movement_intensity = 6;
  if (_has_bit(3)) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(6, this->movement_intensity(), target);
  }
